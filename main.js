...
titleDom.textContent = "JSで変更した後のタイトル";
...
document.getElementById("description").innerHTML = "JSで変更した後の<strong>説明文</strong>";
  ...
  */
document.getElementById("profile").src = "https://www.pakutaso.com/shared/img/thumb/TOMnemuiDSC01757_TP_V1.jpg";
